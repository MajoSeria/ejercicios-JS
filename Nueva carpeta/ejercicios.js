...
function compareSeven() {
    let number = 7
    console.log(number > 8 && number < 10)
}
...
function canBuyProduct() {
    ...
    let dinero= 1150
    console.log( dinero > producto*descuento)
}
...
function logMessage() {
    let nombre= " estoy aprendiendo a codificar en JavaScrip"
...
function logVersion() {
    let mensaje= 'La versión de JavaScript es'
    let version= 2024
